      ...
      <div className="Footer-disclaimer-wrapper">
        <div>
          <p>
            ...
            depicted within this site. All rights go to the rightful owners
            (click images for attribution information).
          </p>
          <p>
            Please submit any game feedback or ideas to{" "}
            <Link href="mailto:fill.m.grid@gmail.com">
              fill.m.grid@gmail.com
            </Link>{" "}
            or via twitter{" "}
